...
@objc public protocol TableViewManagerDelegate: NSObjectProtocol {
    @objc optional func tableViewManager(tableView: TableViewManager, willDisplay cell: CellController)
    @objc optional func tableViewManager(tableView: TableViewManager, willDisplay cell: CellController, indexPath: IndexPath)
    ...
    @objc optional func tableViewManager(table: TableViewManager, didSelectRowAtIndexPath indexPath: IndexPath)

    //old scroll manipulation
    @objc optional func tableViewManager(table: TableViewManager, scrollView: UIScrollView, didChangeScrollOffset newOffset: CGPoint)
    @objc optional func tableViewManager(table: TableViewManager, scrollView: UIScrollView, didDraggedToPosition newOffset: CGPoint)
    @objc optional func tableViewManager(table: TableViewManager, willBeginDragging offset: CGPoint)

    //scroll manipulation
    @objc optional func tableViewManager(tableView: TableViewManager, scrollViewDidScroll scrollView: UIScrollView)
    @objc optional func tableViewManager(tableView: TableViewManager, scrollViewDidEndDragging scrollView: UIScrollView, willDecelerate decelerate: Bool)
    @objc optional func tableViewManager(tableView: TableViewManager, scrollViewWillBeginDragging scrollView: UIScrollView)
    @objc optional func tableViewManager(tableView: TableViewManager, scrollViewDidEndDecelerating scrollView: UIScrollView)
}
